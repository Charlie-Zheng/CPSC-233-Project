...
public class AIGUI extends AI {
	 ...
	 * 
	 * @param mapGUI
	 *            the mapGUI object/map that you want to register
	 * @param combatGUI
	 *            the CombatGUI object you want to register
	 */
	...
	@Override
	/**
	 * Starts the computer's turn, and resets the user's units movements when the AI
	 * is done
	 * 
